// Command server is app-alpha-conformance: a generic starter service for the platform.
//
...
//
// To start a NEW app from this template: copy the repo, rename app-alpha-conformance -> app-<yourapp>, set your
...
func main() {
	...
	go func() {
		log.Printf("starting app-alpha-conformance version=%s namespace=%s", version, namespace)
